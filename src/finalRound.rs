...
use super::util::{join_values, matmul, query, split_value};
use bitvec::ptr::Const;
use halo2_proofs::circuit::{Region, Value};

use halo2_proofs::dev::metadata::VirtualCell;
use halo2_proofs::halo2curves::FieldExt;
use halo2_proofs::plonk::{ConstraintSystem, Error, Expression, VirtualCells};

#[derive(Clone, Debug)]
pub struct FinalRoundChip(
    pub FullState
);
...
impl FinalRoundChip {
    ...
    pub fn assign<F:CachedConstants>(
        &self, region: &mut Region<'_,F>, offset: usize, round_constants:[F;3], input: [Value<F>;3]
